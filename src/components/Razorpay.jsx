    ...
    try {
      ...
      if (configResult.success && configResult.data) {
        ...
        setFormData({
          ...
          webhook_secret: generateRandomWebhookSecret() // Auto-generated by default
        });
      } else {
        // If no config exists, still auto-generate webhook secret
        setFormData({
          key_id: "",
          key_secret: "",
          webhook_secret: generateRandomWebhookSecret() // Auto-generated by default
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Clear sensitive fields and auto-generate new webhook secret
        setFormData(prev => ({
          ...prev,
          key_secret: "",
          webhook_secret: generateRandomWebhookSecret() // Auto-generate new secret
        }));
