          ...
          <div className="row">
            <div className="col-md-6">
              <div className="card border mb-20">
                <div className="card-body p-24">
                  <h6 className="text-sm text-primary-light mb-20">
                      ...
                      {(reseller?.aadhar_photo || reseller?.aadhaar_photo) && (
                        <div className="mb-16">
                          ...
                          <div>
                            {(() => {
                              const photo = (
                                reseller?.aadhar_photo ||
                                reseller?.aadhaar_photo ||
                                ""
                              ).trim();
                              if (!photo)
                                return (
                ...
                {validity ? (
                  <>
                    ...
                    <div className="mb-16">
                      ...
                      <p className="text-md fw-medium text-primary-light mb-0">
                        {validity.validity_start_date
                          ? formatDate(validity.validity_start_date)
                          : "-"}
                      </p>
                    </div>
                    ...
                    <div className="mb-16">
                      ...
                      <p
                        className={`text-md fw-medium mb-0 ${
                          ...
                          new Date(validity.validity_end_date) < new Date()
                            ? "text-danger-600"
                            : "text-primary-light"
                        }`}
                      >
                        {validity.validity_end_date
                          ? formatDate(validity.validity_end_date)
                          : "-"}
                      </p>
                    </div>
                    ...
                    <div className="mb-16">
                      ...
                      <p className="text-md fw-medium text-primary-light mb-0">
                        {validity.last_recharge_amount
                          ? formatCurrency(validity.last_recharge_amount)
                          : "-"}
                      </p>
                    </div>
                  </>
              ...
              <table className="table bordered-table sm-table mb-0">
                ...
                <tbody>
                  {customers.map((customer, index) => {
                    ...
                    const daysLeft = virtualNumber?.expiry_date
                      ? calculateDaysLeft(virtualNumber.expiry_date)
                      : "-";
          ...
          <div className="modal-dialog modal-lg modal-dialog-scrollable">
            <div className="modal-content">
              ...
              <div className="modal-body">
                        ...
                        {isSuperAdmin && (
                          <>
                            ...
                            <div className="mb-16">
                              ...
                              <p className="text-md fw-medium text-primary-light mb-0">
                                {selectedCustomer.pan_dob
                                  ? formatDate(selectedCustomer.pan_dob)
                                  : "-"}
                              </p>
                            </div>
                            ...
                            <div className="mb-16">
                              ...
                              <p className="text-md fw-medium text-primary-light mb-0">
                                {selectedCustomer.aadhaar_dob
                                  ? formatDate(selectedCustomer.aadhaar_dob)
                                  : "-"}
                              </p>
                            </div>
                  ...
                  <div className="col-md-6">
                    <div className="card border mb-20">
                      <div className="card-body p-24">
                        ...
                        {selectedCustomer.mst_virtual_numbers &&
                        selectedCustomer.mst_virtual_numbers.length > 0 ? (
                          selectedCustomer.mst_virtual_numbers.map((vn) => (
                            <div
                              key={vn.id}
                              className="mb-16 pb-16 border-bottom"
                            >
                              <div className="mb-8">
                                <label className="form-label text-xs text-secondary-light mb-4">
                                  Virtual Number
                ...
                {selectedCustomer.mst_transactions &&
                  selectedCustomer.mst_transactions.length > 0 && (
